      ...
      <form>
        ...
        <div className="row">
          <div className="col-12">
            <div id="select-wrapper-23912" className="select-wrapper"><div className="form-outline"><input className="form-control select-input active" type="text" role="listbox" aria-multiselectable="false" aria-disabled="false" aria-haspopup="true" aria-expanded="false" readOnly="true" fdprocessedid="4re6xl" /><label className="form-label select-label active" style={{marginLeft: 0}}>Choose option</label><span className="select-arrow" /><div className="form-notch"><div className="form-notch-leading" style={{width: 9}} /><div className="form-notch-middle" style={{width: '90.4px'}} /><div className="form-notch-trailing" /></div><div className="form-label select-fake-value">Subject 1</div></div><select className="select form-control-lg select-initialized">
